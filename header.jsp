...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <%String email=session.getAttribute("email").toString();%>
            <center><h2>FASHIONLYTIC #WEAR_IT..</h2></center>
            <div class="can-b-2">
            <a href="" style="font-size: 16px;"><%out.println(email); %></a>
            </div>
            ...
            <div class="search-container">
             ...
             <input class="home-search" type="text" placeholder="Search" name="search">
