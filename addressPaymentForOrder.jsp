...
<hr style="width: 100%">
<form action="addressPaymentForOrdersActon.jsp" method="post">
 <div class="left-div">
 <h3>Enter Address</h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="number" name="mobilenumber" value="<%= rs2.getString(3) %>" placeholder="Enter your >Mobile Numbe" required="required">
